...
export type HeroTextBackgroundImage = {
  ...
  size?: "text-base" | "text-lg" | "text-xl" | "text-2xl" | "text-3xl" | "text-4xl" | "text-5xl" | "text-6xl" | "text-7xl" | "text-8xl";
};
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    _key: string;
    text: string | null;
    size: "text-2xl" | "text-3xl" | "text-4xl" | "text-5xl" | "text-6xl" | "text-7xl" | "text-8xl" | "text-base" | "text-lg" | "text-xl" | null;
    image: {
      asset: {
        _id: string;
        url: string | null;
...
// Query: *[_type == "pastProject" && slug.current == $slug][0]{    _type,    name,     slug,    teamMember,    impact,    description,    associatedLink,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    }}
