...
export type AllSanitySchemaTypes = SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityFileAsset | Geopoint | ContactUsForm | AllEvents | AllTeamMembers | AllPosts | AboutYouTest | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | Carousel2 | Carousel1 | GridRow | GridPost | PricingCard | GridCard | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | SectionHeader | HeroFlexText | HeroColorBodyText | HeroTextCentered | HeroWithImage | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Event | TeamMember | Testimonial | Faq | Category | Post | Author | Page | SanityImageCrop | SanityImageHotspot | SanityImageAsset | SanityAssetSourceData | SanityImageMetadata | Slug | Code;
...
// Query: *[_type == "event" && defined(slug)] | order(startDateTime asc){    _type,    name,     startDateTime,    endDateTime,    address,    city,    state,    externalLink,    description,    slug,    image{      asset->{        _id,        url,        mimeType,        metadata {          lqip,          dimensions {            width,            height          }        }      },      alt    }}
...
// Query: *[_type == "team-member" && defined(slug)]{slug}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == \"event\" && defined(slug)] | order(startDateTime asc){\n    _type,\n    name, \n    startDateTime,\n    endDateTime,\n    address,\n    city,\n    state,\n    externalLink,\n    description,\n    slug,\n    image{\n      asset->{\n        _id,\n        url,\n        mimeType,\n        metadata {\n          lqip,\n          dimensions {\n            width,\n            height\n          }\n        }\n      },\n      alt\n    }\n}": EVENTS_QUERYResult;
