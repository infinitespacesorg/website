...
export default function ElseHeader() {
  ...
  const [navItems, setNavItems] = useState<NavItem[]>([
    ...
    { label: "Login", href: "https://playbox.infinitespaces.co/auth/login?redirect_to=https://infinitespaces.co/auth/callback?redirect_to=/account/profile", target: false },
  ]);
